...
class TestKeys(BaseTest):
    ...
    def test_mapping(self):
        ...
        tm = TM('map ctrl+f>m new_window')
        self.ae(tm('ctrl+f'), [True])
        self.assertIn('m  New window', tm.active_window.sequence_hint)
        self.assertNotIn('M  New window', tm.active_window.sequence_hint)
        self.ae(tm('escape'), [True])
        tm = TM('map ctrl+f>2 set_font_size 20')
